  ...
  return (
    <div className="container-page py-12">
      ...
      <p className="mt-3 max-w-2xl text-white/70">
        Create a Tobias Tech Hub account for a faster shopping and quote experience.
      </p>
      ...
      <div className="mt-10 max-w-lg rounded-2xl border border-white/10 bg-black/20 p-6">
        ...
        >
          ...
          <p className="text-sm text-white/60">
            ...
            <Link className="font-semibold text-emerald-200 hover:text-emerald-100" href="/account/sign-in">
              Sign in
            </Link>
            .
          </p>
          <p className="text-xs text-white/40">
            Demo auth: stored locally in your browser. Swap to real auth + server validation before launch.
          </p>
        </form>
      </div>
    </div>
